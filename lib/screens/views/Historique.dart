                            ...
                            Container(
                              child: Material(
                                ...
                                child: TabBar(
                                  ...
                                  labelStyle: TextStyle(fontSize: ResponsiveFlutter.of(context).fontSize(3),fontWeight: FontWeight.bold),  //For Selected tab
                                  unselectedLabelStyle: TextStyle(fontSize: ResponsiveFlutter.of(context).fontSize(1.57),fontWeight: FontWeight.bold),
                                  tabs: [
                                    Tab(text: "2019"),
                                    Tab(text: "2020"),
                                    Tab(text: "2021"),
                                                ...
                                                Center(
                                                  child: SizedBox(
                                                    child: Container(
                                                      ...
                                                      child: Center(child: Text(getmonth(snapshot.data[index].mois),style: TextStyle(fontSize: ResponsiveFlutter.of(context).fontSize(3),color: Colors.white , fontWeight: FontWeight.bold),),),
                                                    ),
                                                  ),
                                                ),
                                                Padding(
                                                    ...
                                                    children: [
                                                      RichText(
                                                        text: TextSpan(
                                                          ...
                                                          children: <TextSpan>[
                                                            TextSpan(text: snapshot.data[index].nbLivraisons.toString(), style : TextStyle(fontSize: ResponsiveFlutter.of(context).fontSize(2.0),color: Colors.black , fontWeight: FontWeight.bold),),
                                                          ],
                                                        ),
                                                      ),
                                                      ...
                                                      RichText(
                                                        text: TextSpan(
                                                          ...
                                                          style: TextStyle(fontSize: ResponsiveFlutter.of(context).fontSize(2.0),color: violet),
                                                          children: <TextSpan>[
                                                            TextSpan(text: snapshot.data[index].distanceTotale.toString(), style : TextStyle(fontSize: ResponsiveFlutter.of(context).fontSize(2.0),color: Colors.black , fontWeight: FontWeight.bold),),
                                                          ],
                                                        ),
                                                      ),
                                                    ],
